<?php
/**
 * Inline SVG icon set (Feather-style, 24x24 stroke).
 * Usage:  <?= icon('users', 'nav-link__icon') ?>
 */
    ...
    function icon(string $name, string $class = ''): string
    {
        ...
        if ($paths === null) {
            $paths = [
                ...
                'sun'         => '<circle cx="12" cy="12" r="4.2"/><line x1="12" y1="1.6" x2="12" y2="4"/><line x1="12" y1="20" x2="12" y2="22.4"/><line x1="4.2" y1="4.2" x2="5.9" y2="5.9"/><line x1="18.1" y1="18.1" x2="19.8" y2="19.8"/><line x1="1.6" y1="12" x2="4" y2="12"/><line x1="20" y1="12" x2="22.4" y2="12"/><line x1="4.2" y1="19.8" x2="5.9" y2="18.1"/><line x1="18.1" y1="5.9" x2="19.8" y2="4.2"/>',
                ...
                'receipt'     => '<path d="M4 2v20l2-1.5L8 22l2-1.5L12 22l2-1.5L16 22l2-1.5L20 22V2l-2 1.5L16 2l-2 1.5L12 2l-2 1.5L8 2 6 3.5 4 2z"/><line x1="8" y1="8" x2="16" y2="8"/><line x1="8" y1="12" x2="16" y2="12"/><line x1="8" y1="16" x2="13" y2="16"/>',
        ...
        // An SVG with no width/height fills its container, so always ship a
        // class. Callers that pass their own opt out of the default sizing.
        $class = trim($class) !== '' ? trim($class) : 'icon';
